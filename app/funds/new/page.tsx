  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-6">
        <Link
          href="/funds"
          className="w-7 h-7 flex items-center justify-center rounded-full border border-[#e8e6df] bg-white hover:bg-[#f9f8f5] transition-colors text-[#6b6860]"
        >
          ←
        </Link>
      ...
      <div className="bg-white border border-[#e8e6df] rounded-xl p-6 mb-4">
        ...
        {/* Fund Name */}
        <div className="mb-5">
          <label className="block text-[13px] font-medium mb-1">Fund Name</label>
          <input
            type="text"
            value={form.name}
            onChange={set('name')}
        ...
        <div className="grid grid-cols-2 gap-4 mb-5">
          <div>
            <label className="block text-[13px] font-medium mb-1">Commitment Amount</label>
            <input
              type="number"
              value={form.committed}
              onChange={set('committed')}
              placeholder="0"
              className={inputCls('committed')}
            />
            <p className="text-[11.5px] text-[#9b9890] mt-1">Total committed capital (e.g., 150000000 for $150M)</p>
        ...
        <div className="grid grid-cols-3 gap-4 mb-5">
          ...
          <div>
            ...
            <input
              type="number"
              value={form.fundLife}
              onChange={set('fundLife')}
              min="1" max="20"
              className={inputCls('fundLife')}
            />
        ...
        <div className="mb-5">
          ...
          <input
            ...
            value={form.focus}
            onChange={set('focus')}
            placeholder="e.g., B2B SaaS, Healthcare Tech, Fintech"
            className={inputCls('focus')}
          />
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            placeholder="e.g., Early-stage venture fund focused on enterprise software companies in North America with check sizes of $2-5M..."
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={inputCls('managementFee') + ' pr-7'}
              />
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={set('carriedInterest')}
                className={inputCls('carriedInterest') + ' pr-7'}
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#9b9890] text-[13px]">%</span>
            </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={inputCls('hurdleRate') + ' pr-7'}
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#9b9890] text-[13px]">%</span>
            </div>
      ...
      <div className="flex items-center justify-end gap-3 pb-8">
        <Link
          href="/funds"
          className="px-5 py-2 rounded-[7px] text-[13px] font-medium border border-[#e8e6df] bg-white hover:bg-[#f9f8f5] transition-colors"
        >
          Cancel
        </Link>
        <button
